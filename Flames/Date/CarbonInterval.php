...
use Flames\Date\Constants\UnitValue;
use Flames\Date\Exceptions\BadFluentConstructorException;
use Flames\Date\Exceptions\BadFluentSetterException;
use Flames\Date\Exceptions\InvalidCastException;
use Flames\Date\Exceptions\InvalidFormatException;
use Flames\Date\Exceptions\InvalidIntervalException;
use Flames\Date\Exceptions\OutOfRangeException;
use Flames\Date\Exceptions\ParseErrorException;
use Flames\Date\Exceptions\UnitNotConfiguredException;
use Flames\Date\Exceptions\UnknownGetterException;
use Flames\Date\Exceptions\UnknownSetterException;
use Flames\Date\Exceptions\UnknownUnitException;
use Flames\Date\Traits\IntervalRounding;
use Flames\Date\Traits\IntervalStep;
use Flames\Date\Traits\LocalFactory;
use Flames\Date\Traits\MagicParameter;
use Flames\Date\Traits\Mixin;
use Flames\Date\Traits\Options;
use Flames\Date\Traits\ToStringFormat;
use Closure;
use DateInterval;
use DateTime;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface, UnitValue
{
     ...
     *
     * @throws \Flames\Date\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
     ...
     *
     * @param \Flames\Date\Carbon|\DateTimeInterface|mixed $start
     * @param \Flames\Date\Carbon|\DateTimeInterface|mixed $end
     *
     * @return static
     */
