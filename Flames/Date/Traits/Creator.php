...
namespace Flames\Date\Traits;

use Flames\Date\Carbon;
use Flames\Date\CarbonImmutable;
use Flames\Date\CarbonInterface;
use Flames\Date\Exceptions\InvalidDateException;
use Flames\Date\Exceptions\InvalidFormatException;
use Flames\Date\Exceptions\InvalidTimeZoneException;
use Flames\Date\Exceptions\OutOfRangeException;
use Flames\Date\Exceptions\UnitException;
use Flames\Date\Month;
use Flames\Date\Translator;
use Flames\Date\WeekDay;
use Closure;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat(string $format, string $time, $timezone = null): ?static
    {
        ...
        /** @var \Flames\Date\CarbonImmutable|\Flames\Date\Carbon|null $mock */
