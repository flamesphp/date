...
use Flames\Date\Exceptions\EndLessPeriodException;
use Flames\Date\Exceptions\InvalidCastException;
use Flames\Date\Exceptions\InvalidIntervalException;
use Flames\Date\Exceptions\InvalidPeriodDateException;
use Flames\Date\Exceptions\InvalidPeriodParameterException;
use Flames\Date\Exceptions\NotACarbonClassException;
use Flames\Date\Exceptions\NotAPeriodException;
use Flames\Date\Exceptions\UnknownGetterException;
use Flames\Date\Exceptions\UnknownMethodException;
use Flames\Date\Exceptions\UnreachableException;
use Flames\Date\Traits\DeprecatedPeriodProperties;
...
class CarbonPeriod extends DatePeriodBase implements Countable, JsonSerializable, UnitValue
{
     ...
     *
     * @param \Flames\Date\Carbon|\Flames\Date\CarbonPeriod|\Flames\Date\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \Flames\Date\CarbonInterface
     */
